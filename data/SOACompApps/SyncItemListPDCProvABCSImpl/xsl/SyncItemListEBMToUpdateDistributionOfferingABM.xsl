...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="/">
    <ns1:PricingObjectsJXB>
      <xsl:for-each select="fn:distinct-values(/eboebo:SyncItemListEBM/eboebo:DataArea[eboebo:SyncItemList/ns4:ItemServiceCharacteristics/ns4:BillingEntityTypeCode = &quot;SPONSORSHIP&quot; and ns8:Sync/@syncActionCode = &quot;update&quot;]/eboebo:SyncItemList/ns4:ItemSpecificationGroup/ns8:SpecificationGroup[ns8:Name = &quot;Sponsorship_Event_Map&quot;]/ns8:Specification[ns8:Name = &quot;Charge_Share_Model&quot;]/ns8:ValueText)">
      ...
      <xsl:for-each select='/eboebo:SyncItemListEBM/eboebo:DataArea[(eboebo:SyncItemList/ns4:ItemServiceCharacteristics/ns4:BillingEntityTypeCode = "SPONSORSHIP") and (ns8:Sync/@syncActionCode = "update")]'>
        <distributionOffering>
          ...
          <xsl:variable name="EBMExternalCommonId" select="eboebo:SyncItemList/ns8:ItemIdentification/ns8:BusinessComponentID"/>
          ...
          <xsl:for-each select='eboebo:SyncItemList/ns4:ItemSpecificationGroup/ns8:SpecificationGroup[ns8:Name = "Sponsorship_Event_Map"]'>
            <distributionEventMap>
              ...
              <xsl:if test="boolean(ns8:Specification[ns8:Name = &quot;Charge_Share_Model&quot;]/ns8:ValueText/text())">
                  ...
                  <xsl:variable name="IfSponsorshipModelIdExists" select="xref:lookupXRef('oramds:/apps/AIAMetaData/xref/SPONSORSHIPOBJECT_ID.xref',$SourceCol,ns8:Specification[ns8:Name = &quot;Charge_Share_Model&quot;]/ns8:ValueText,$TargetCol,false())"/>
                  <xsl:if test="$IfSponsorshipModelIdExists != ''">
                     <ratePlanIID>
                         <xsl:value-of select="$IfSponsorshipModelIdExists"/>
                     </ratePlanIID>
                  </xsl:if>
              </xsl:if>
            </distributionEventMap>
