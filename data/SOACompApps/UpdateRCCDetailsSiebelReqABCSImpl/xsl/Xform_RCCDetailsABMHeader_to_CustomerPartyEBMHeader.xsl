  ...
  <xsl:template name="EBMHeader">
       ...
       <xsl:param name="IntegrationScenarioName"/-->
        <corecom:EBMHeader>
            ...
            <corecom:EBMName>
                <xsl:text>{http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/CustomerParty/V2}UpdateCustomerPartyEBM</xsl:text>
            </corecom:EBMName>
            <corecom:EBOName>
                <xsl:text>{http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/CustomerParty/V2}UpdateCustomerPartyEBO</xsl:text>
            </corecom:EBOName>
	    ...
	    <corecom:MessageProcessingInstruction>
                <xsl:variable name="ConfigServiceName" select="'{http://xmlns.oracle.com/ABCSImpl/Siebel/Industry//UpdateRCCDetailsSiebelReqABCSImpl/V1}UpdateRCCDetailsSiebelReqABCSImpl'"/>
                <xsl:variable name="RouteToCAVS" select="aia:getServiceProperty($ConfigServiceName, 'Routing.CommunicationsCustomerPartyEBSVnull.ProcessCreditEligibilityVerification.RouteToCAVS', false())='true'"/>
                <corecom:EnvironmentCode>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:variable name="EnvCode" select="aia:getServiceProperty($ConfigServiceName,'Routing.CommunicationsCustomerPartyEBSVnull.ProcessCreditEligibilityVerification.MessageProcessingInstruction.EnvironmentCode',false())"/>
                            <xsl:choose>
                ...
                <xsl:if test="$RouteToCAVS">
                        <xsl:value-of select="aia:getServiceProperty($ConfigServiceName, 'Routing.CommunicationsCustomerPartyEBSVnull.ProcessCreditEligibilityVerification.CAVS.EndpointURI', false())"/>
                </xsl:if>
				</corecom:DefinitionID>
	    ...
	    <!--xsl:copy-of select="$Sender"/-->
            <corecom:Target>
                <corecom:ID><xsl:text>BRM_01</xsl:text></corecom:ID>
            ...
            <corecom:BusinessScope>
                ...
                <corecom:InstanceID>
                    <xsl:value-of select="concat('UpdateCustomerParty/',orcl:generate-guid())"/>
                </corecom:InstanceID>
                <corecom:BusinessScopeTypeCode>BusinessProcess</corecom:BusinessScopeTypeCode>
                <corecom:EnterpriseServiceName>{http://xmlns.oracle.com/EnterpriseServices/Core/CustomerParty/V2}CommunicationsCustomerPartyEBSVnull</corecom:EnterpriseServiceName>
                <corecom:EnterpriseServiceOperationName>ProcessCreditEligibilityVerification</corecom:EnterpriseServiceOperationName>
                <xsl:call-template name="BusinessScopeType_ext"/>
            </corecom:BusinessScope>
            <corecom:BusinessScope>
                <corecom:ID>ProcessCreditEligibilityVerificationReqMsg</corecom:ID>
                <corecom:InstanceID>
                    <xsl:value-of select="concat('ProcessCreditEligibilityVerificationReqMsg/',$EBMID)"/>
                </corecom:InstanceID>
            ...
            <corecom:EBMTracking>
                ...
                <corecom:ExecutionUnitName>{http://xmlns.oracle.com/ABCSImpl/Siebel/Industry//UpdateRCCDetailsSiebelReqABCSImpl/V1}UpdateRCCDetailsSiebelReqABCSImpl</corecom:ExecutionUnitName>
    ...
    <xsl:template name="GetSenderNode">
        ...
        <xsl:variable name="SenderID">
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <xsl:value-of select="aia:getServiceProperty('{http://xmlns.oracle.com/ABCSImpl/Siebel/Industry//UpdateRCCDetailsSiebelReqABCSImpl/V1}UpdateRCCDetailsSiebelReqABCSImpl','Default.SystemID',true())"/>
                </xsl:otherwise>
            </xsl:choose>
        </xsl:variable>
        ...
        <corecom:Sender>
            ...
            <corecom:CallingServiceName>
                <xsl:text>{http://xmlns.oracle.com/ABCSImpl/Siebel/Industry//UpdateRCCDetailsSiebelReqABCSImpl/V1}UpdateRCCDetailsSiebelReqABCSImpl</xsl:text>
            </corecom:CallingServiceName>
            <corecom:Application>
                <corecom:ID>
