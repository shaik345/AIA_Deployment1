...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      ...
      <rootElement name="SWIProductLine_Synchronize_Output" namespace="http://siebel.com/asi/"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="XSD">
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.5.0(build 110418.1550.0174) AT [WED JUN 04 14:56:19 IST 2014]. -->
?>
<xsl:stylesheet version="1.0"
		...
		<xsl:include href="XformSiebelSyncProdLineABMToSyncItemListResponseEBM_Custom.xsl"/>
                  ...
                  <ns0:DataArea>
                    <ns0:SyncItemListResponse>
                      <corecom:ItemIdentification>
                       <xsl:variable name="ProdName" select="/tns:SWIProductLine_Synchronize_Output/xsdLocal1:ListOfAdminProductLine/xsdLocal1:AdminProductLine/xsdLocal1:Name"/>
                       <xsl:variable name="CommonCol">
                        ...
                        <corecom:BusinessComponentID>
                         <xsl:value-of select="$CommonCol"/>
                        </corecom:BusinessComponentID>
                        <xsl:variable name="targetId">
                         <xsl:choose>
                           <xsl:when test="xref:lookupXRef('oramds:/apps/AIAMetaData/xref/PRODUCTLINE_ID.xref',$XREFSourceCol,$CommonCol,$systemId,false()) = ''">
                            <xsl:value-of select="xref:populateXRefRow('oramds:/apps/AIAMetaData/xref/PRODUCTLINE_ID.xref',$XREFSourceCol,$CommonCol,$systemId,/tns:SWIProductLine_Synchronize_Output/xsdLocal1:ListOfAdminProductLine/xsdLocal1:AdminProductLine/xsdLocal1:Id,'ANY')"/>
                           </xsl:when>
                           <xsl:otherwise>
                            <xsl:value-of select="xref:lookupXRef('oramds:/apps/AIAMetaData/xref/PRODUCTLINE_ID.xref',$XREFSourceCol,$CommonCol,$systemId,false())"/>
                           </xsl:otherwise>
                         </xsl:choose>
                        </xsl:variable>
                        <xsl:copy-of select="$EBMDataAreaVariable/ns0:DataArea/ns0:SyncItemList[corecomEBO:Name=$ProdName]/corecom:ItemIdentification/corecom:ApplicationObjectKey"/>
                        <xsl:copy-of select="$EBMDataAreaVariable/ns0:DataArea/ns0:SyncItemList[corecomEBO:Name=$ProdName]/corecom:ItemIdentification/corecom:Revision"/>
                      </corecom:ItemIdentification>
                    </ns0:SyncItemListResponse>
                  </ns0:DataArea>
                </ns0:SyncItemListResponseEBM>
