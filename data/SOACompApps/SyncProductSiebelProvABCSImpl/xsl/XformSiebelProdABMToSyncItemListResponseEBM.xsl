...
<!--  <xsl:variable name="EBMHeaderVariable"
                select="orcl:parseEscapedXML($EBMHeaderParam)"/>
  ...
  <xsl:template match="/">
    <coreeboitem:SyncItemListResponseEBM>
      ...
      <xsl:for-each select="/tns:SWIProductImportUpsert_Output/xsdLocal1:ListOfProductImport/xsdLocal1:ProductIntegration/xsdLocal1:ListOfProductDefinition/xsdLocal1:ProductDefinition">
         <xsl:variable name="ProdName" select="xsdLocal1:ProductName"/>      
        <coreeboitem:DataArea>
          <coreeboitem:SyncItemListResponse>
            <corecom:ItemIdentification>
              <corecom:BusinessComponentID>
                <xsl:variable name="targetID">
                      <xsl:value-of select="xref:populateXRefRow('oramds:/apps/AIAMetaData/xref/ITEM_ITEMID.xref',$XREFSourceCol,xsdLocal1:IntegrationId,$systemId,xsdLocal1:ProductId,'ANY')"/>
                </xsl:variable>
                ...
                <xsl:copy-of select="$EBMDataAreaVariable/coreeboitem:DataArea/coreeboitem:SyncItemList[corecomEBO:Name=$ProdName]/corecom:ItemIdentification/corecom:Revision"/>
            </corecom:ItemIdentification>
            <corecomEBO:InventoryLocation>
              <corecom:Identification>
                <corecom:BusinessComponentID>
                  <xsl:value-of select="xref:lookupXRef(&quot;oramds:/apps/AIAMetaData/xref/INVENTORY_LOCATION_ID.xref&quot;,$systemId,xsdLocal1:ListOfProductInvloc/xsdLocal1:ProductInvloc/xsdLocal1:InventoryLocationID,$XREFSourceCol,true())"/>
                </corecom:BusinessComponentID>
              </corecom:Identification>
            </corecomEBO:InventoryLocation>
          </coreeboitem:SyncItemListResponse>
