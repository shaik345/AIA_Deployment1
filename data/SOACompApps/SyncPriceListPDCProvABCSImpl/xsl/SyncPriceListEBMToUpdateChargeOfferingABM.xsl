	...
	<xsl:template match="/">
		<ns6:PricingObjectsJXB>
			<xsl:for-each select="eboebo:SyncPriceListListEBM/eboebo:DataArea[((eboebo:SyncPriceListList/eboebo:PriceListLine/ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'BillingTypeCode']/ns2:ValueCode = 'SUBSCRIPTION') or (eboebo:SyncPriceListList/eboebo:PriceListLine/ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'BillingTypeCode']/ns2:ValueCode = 'SYSTEM') or (eboebo:SyncPriceListList/eboebo:PriceListLine/ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'BillingTypeCode']/ns2:ValueCode = 'ITEM')) and (eboebo:SyncPriceListList/@actionCode = 'update')]">
				<xsl:for-each select="eboebo:SyncPriceListList/eboebo:PriceListLine/eboebo:LinePrice">
					...
					<xsl:for-each select="eboebo:RatePlan">
						...
						<xsl:if test="$event_type=&quot;RECURRING&quot; or $event_type = &quot;ONETIME&quot; or $event_type = &quot;USAGE&quot;">
							<chargeRatePlan>
								<name>
								...
								<xsl:if test="$IfChargeRatePlanIdExists != ''">
									<internalId>
										<xsl:value-of select="$IfChargeRatePlanIdExists"/>
									</internalId>
								</xsl:if>
								<pricingProfileName>
			...
			<xsl:for-each select="eboebo:SyncPriceListListEBM/eboebo:DataArea[((eboebo:SyncPriceListList/eboebo:PriceListLine/ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'BillingTypeCode']/ns2:ValueCode = 'SUBSCRIPTION') or (eboebo:SyncPriceListList/eboebo:PriceListLine/ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'BillingTypeCode']/ns2:ValueCode = 'SYSTEM') or (eboebo:SyncPriceListList/eboebo:PriceListLine/ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'BillingTypeCode']/ns2:ValueCode = 'ITEM')) and (eboebo:SyncPriceListList/@actionCode = 'update')]">
				<xsl:for-each select="eboebo:SyncPriceListList/eboebo:PriceListLine/eboebo:LinePrice">
					<xsl:variable name="pricing_profile" select="dvm:lookupValue(&quot;oramds:/apps/AIAMetaData/dvm/PRICETYPE_EVENT.dvm&quot;,$SourceCol,eboebo:TypeCode,'PRICINGPROFILE_PDC',&quot;&quot;)"/>
					<xsl:if test="boolean(eboebo:RatePlan[1]/eboebo:PriceListRatePlanSelector/eboebo:Name/text())">
						<chargeRateplanSelector>
							...
							<xsl:variable name="IfChargeRatePlanSelcIdExists" select="xref:lookupXRef('oramds:/apps/AIAMetaData/xref/CHARGERATEPLANSELECTOR_ID.xref',$SourceCol,concat(eboebo:RatePlan[1]/eboebo:PriceListRatePlanSelector/eboebo:Name,'-',../ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'InternalItemCode']/ns2:ValueText),$TargetCol,false())"/>
							<xsl:if test="$IfChargeRatePlanSelcIdExists != ''">
								<internalId>
									<xsl:value-of select="$IfChargeRatePlanSelcIdExists"/>
								</internalId>
							</xsl:if>
							<pricingProfileName>
								<xsl:value-of select="$pricing_profile"/>
			...
			<xsl:for-each select="eboebo:SyncPriceListListEBM/eboebo:DataArea[((eboebo:SyncPriceListList/eboebo:PriceListLine/ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'BillingTypeCode']/ns2:ValueCode = 'SUBSCRIPTION') or (eboebo:SyncPriceListList/eboebo:PriceListLine/ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'BillingTypeCode']/ns2:ValueCode = 'SYSTEM') or (eboebo:SyncPriceListList/eboebo:PriceListLine/ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'BillingTypeCode']/ns2:ValueCode = 'ITEM')) and (eboebo:SyncPriceListList/@actionCode = 'update')]">
				<chargeOffering>
					...
					<xsl:variable name="EBMExternalCommonId" select="eboebo:SyncPriceListList/eboebo:PriceListLine/ns2:ItemReference/ns2:ItemIdentification/ns2:BusinessComponentID"/>
					<xsl:variable name="IfExternalIdExists" select="xref:lookupXRef('oramds:/apps/AIAMetaData/xref/ITEM_ITEMID.xref',$SourceCol,$EBMExternalCommonId,$TargetCol,false())"/>
					...
					<xsl:for-each select="eboebo:SyncPriceListList/eboebo:PriceListLine/eboebo:LinePrice">
						<chargeEventMap>
								...
								<xsl:when test="eboebo:RatePlanTypeCode = 'SINGLE_RATE_PLAN' or eboebo:RatePlanTypeCode = 'RATE_PLAN_SELECTOR'">
									...
									<xsl:choose>
										<xsl:when test="boolean(eboebo:RatePlan[1]/eboebo:RateDetail/eboebo:PlanTier[1]/eboebo:PriceListUnrestrictedRateData/eboebo:PriceListRateData/eboebo:CancelationRecurringChargeProrationCode/text())">
											<prorateLast>
												<xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/AIAMetaData/dvm/RATEDATA_PURCHASEPRORATIONCODE.dvm&quot;,$SourceCol,eboebo:RatePlan[1]/eboebo:RateDetail/eboebo:PlanTier[1]/eboebo:PriceListUnrestrictedRateData/eboebo:PriceListRateData/eboebo:CancelationRecurringChargeProrationCode,$TargetCol,&quot;&quot;)"/>
											</prorateLast>
										</xsl:when>
										<xsl:otherwise>
											<prorateLast>
							...
							<xsl:if test="eboebo:RatePlanTypeCode = 'SINGLE_RATE_PLAN' or eboebo:RatePlanTypeCode = 'PIPELINE_SINGLE_RATE_PLAN'">
								...
								<xsl:variable name="IfChargeRatePlanIdExists" select="xref:lookupXRef('oramds:/apps/AIAMetaData/xref/CHARGERATEPLAN_ID.xref',$SourceCol,concat(eboebo:RatePlan/eboebo:Name,'-',../ns2:ItemReference/ns2:SpecificationGroup/ns2:Specification[ns2:Name = 'InternalItemCode']/ns2:ValueText),$TargetCol,false())"/>
								<xsl:if test="$IfChargeRatePlanIdExists != ''">
									<ratePlanIID>
										<xsl:value-of select="$IfChargeRatePlanIdExists"/>
									</ratePlanIID>
