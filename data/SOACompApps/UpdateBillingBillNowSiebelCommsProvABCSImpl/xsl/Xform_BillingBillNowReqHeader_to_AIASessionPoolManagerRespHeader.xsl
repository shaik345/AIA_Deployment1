...
<xsl:stylesheet version="2.0"
   ...
   <xsl:template match="corecom:EBMHeader">
    <corecom:EBMHeader>
        ...
        <corecom:EBMName>
            <xsl:text>{http://xmlns.oracle.com/AIASessionPoolManager}UpdateAIASessionPoolManagerEBM</xsl:text>
        </corecom:EBMName>
        <corecom:EBOName>
            <xsl:text>{http://xmlns.oracle.com/AIASessionPoolManager}UpdateAIASessionPoolManagerEBO</xsl:text>
        </corecom:EBOName>
        ...
        <corecom:MessageProcessingInstruction>
            <xsl:variable name="ConfigServiceName" select="'{http://xmlns.oracle.com/ABCSImpl/SiebelComms/Industry//UpdateBillingBillNowSiebelCommsProvABCSImpl/V1}UpdateBillingBillNowSiebelCommsProvABCSImpl'"/>
            <xsl:variable name="RouteToCAVS" select="aia:getServiceProperty($ConfigServiceName,'Routing.AIASessionPoolManagerV1.Get.RouteToCAVS',false())='true'"/>
            <corecom:EnvironmentCode>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:variable name="EnvCode" select="aia:getServiceProperty($ConfigServiceName,'Routing.AIASessionPoolManagerV1.Get.MessageProcessingInstruction.EnvironmentCode',false())"/>
                        <xsl:choose>
            ...
            <xsl:if test="$RouteToCAVS">
                    <xsl:value-of select="aia:getServiceProperty($ConfigServiceName,'Routing.AIASessionPoolManagerV1.Get.CAVS.EndpointURI',false())"/>
            </xsl:if>
            </corecom:DefinitionID>
        ...
        <corecom:BusinessScope>
            ...
            <corecom:EnterpriseServiceName>{http://xmlns.oracle.com/AIASessionPoolManager}AIASessionPoolManagerV1</corecom:EnterpriseServiceName>
            <corecom:EnterpriseServiceOperationName>Get</corecom:EnterpriseServiceOperationName>
            <xsl:call-template name="BusinessScopeType_ext"/>
        </corecom:BusinessScope>
        <corecom:BusinessScope>
            <corecom:ID>GetAIASessionPoolManagerGetRequest</corecom:ID>
            <corecom:InstanceID>
                <xsl:value-of select="concat('GetAIASessionPoolManagerGetRequest/',$EBMID)"/>
            </corecom:InstanceID>
        ...
        <corecom:EBMTracking>
            ...
            <corecom:ExecutionUnitName>{http://xmlns.oracle.com/ABCSImpl/SiebelComms/Industry//UpdateBillingBillNowSiebelCommsProvABCSImpl/V1}UpdateBillingBillNowSiebelCommsProvABCSImpl</corecom:ExecutionUnitName>
