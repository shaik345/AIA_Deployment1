...
<xsl:stylesheet version="2.0"
  ...
  <xsl:param name="ConfigServiceName">{http://xmlns.oracle.com/ABCSImpl/SiebelComms/Industry//UpdateBillingBillNowSiebelCommsProvABCSImpl/V1}UpdateBillingBillNowSiebelCommsProvABCSImpl</xsl:param>
